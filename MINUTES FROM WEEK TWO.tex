...
What's next     & It doesn't work anymore, quick council with sir Sprik and praying that it will work today.\\ \hline
\end{tabular}
\end{table}
...
Who             & AL, CM, SM, Jn\\ \hline
How             & Asking for advice on the code and asking for feedback on our work progress \\ \hline
What's next     & Implementing \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{1.5in}|p{4in}|}
\hline
Date/Time/Place & 18/06/24, 12.00-13.30, SP \\ \hline
What            & Working on poster  \\ \hline
Who             & JN \\ \hline
