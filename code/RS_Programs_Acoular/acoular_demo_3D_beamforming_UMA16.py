"""
Based on: Example "3D beamforming" for Acoular library.
array: UMA16v2
...
# ===============================================================================
grdsz = 0.2; distm = 0.1; distx = 0.4
g = RectGrid3D(x_min=-grdsz, x_max=grdsz, y_min=-grdsz, y_max=grdsz, z_min=distm, z_max=distx, increment=0.01)
...
f = PowerSpectra(time_data=pa, window='Hanning', overlap='50%', block_size=128)
